...
const uint8_t paramBlock[] __attribute__((address(0x820))) = {
    ...
    0,
    0,
    ((MANU_MERG+'c'+MTYP_CANPAN+254 +13 +1 +4 +(8) +(8)+CPUM_MICROCHIP+105 +(20)+(0x48)+(0x08)+1 +2 +PB_CAN+P18F27Q83)&0xFF),
    ((MANU_MERG+'c'+MTYP_CANPAN+254 +13 +1 +4 +(8) +(8)+CPUM_MICROCHIP+105 +(20)+(0x48)+(0x08)+1 +2 +PB_CAN+P18F27Q83)>>8)
};
