    ...
    if (mode_state == MODE_SETUP) {
        switch (m->opc) {
            case OPC_SNN:
                ...
                return PROCESSED;
            case OPC_RQNP:
                sendMessage7(OPC_PARAMS, MANU_MERG, 'y',
                        MTYP_CANPAN, 254, 13,
                        1, 1);
                return PROCESSED;
            case OPC_RQMN:
