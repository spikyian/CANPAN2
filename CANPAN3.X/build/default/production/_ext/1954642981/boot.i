...
const uint8_t paramBlock[] __attribute__((address(0x820))) = {
    ...
    0,
    0,
    ((MANU_MERG+'a'+MTYP_CANPAN+255 +20 +1 +5 +(8) +(8)+CPUM_MICROCHIP+1 +(20)+(0x48)+(0x08)+1 +2 +PB_CAN+P18F26K80)&0xFF),
    ((MANU_MERG+'a'+MTYP_CANPAN+255 +20 +1 +5 +(8) +(8)+CPUM_MICROCHIP+1 +(20)+(0x48)+(0x08)+1 +2 +PB_CAN+P18F26K80)>>8)
};
