...
# 52 "../../VLCBlib_PIC/event_teach_simple.c" 2
...
# 55 "../../VLCBlib_PIC/event_teach_simple.c" 2
...
# 97 "../../VLCBlib_PIC/event_teach_simple.c"
...
# 155 "../../VLCBlib_PIC/event_teach_simple.c"
...
# 181 "../../VLCBlib_PIC/event_teach_simple.c"
static void teachFactoryReset(void) {
    clearAllEvents();
}
...
# 207 "../../VLCBlib_PIC/event_teach_simple.c"
static Processed teachProcessMessage(Message* m) {
    switch(m->opc) {
...
# 329 "../../VLCBlib_PIC/event_teach_simple.c"
static Processed teachCheckLen(Message * m, uint8_t needed, uint8_t learn) {
    if (learn) {
...
# 368 "../../VLCBlib_PIC/event_teach_simple.c"
...
# 383 "../../VLCBlib_PIC/event_teach_simple.c"
static void clearAllEvents(void) {
    uint8_t tableIndex;
    uint8_t i;
...
# 672 "../../VLCBlib_PIC/event_teach_simple.c"
uint8_t removeEvent(uint16_t nodeNumber, uint16_t eventNumber) {
...
static uint8_t removeTableEntry(uint8_t tableIndex) {
    ...
    writeNVM(FLASH_NVM_TYPE, 0xEF80 + (sizeof(Event) + 1 + 20)*tableIndex + 0, 0x00);
    writeNVM(FLASH_NVM_TYPE, 0xEF80 + (sizeof(Event) + 1 + 20)*tableIndex + 1, 0x00);
    writeNVM(FLASH_NVM_TYPE, 0xEF80 + (sizeof(Event) + 1 + 20)*tableIndex + 2, 0x00);
    writeNVM(FLASH_NVM_TYPE, 0xEF80 + (sizeof(Event) + 1 + 20)*tableIndex + 3, 0x00);
    writeNVM(FLASH_NVM_TYPE, 0xEF80 + (sizeof(Event) + 1 + 20)*tableIndex + 4, 0x00);

    for (i=0; i<20; i++) {
        writeNVM(FLASH_NVM_TYPE, 0xEF80 + (sizeof(Event) + 1 + 20)*tableIndex + (5 + i), 0x00);
    }
    flushFlashBlock();
    return 0;
}
# 718 "../../VLCBlib_PIC/event_teach_simple.c"
    ...
    if (tableIndex == 0xff) {
        ...
        for (tableIndex=0; tableIndex<255; tableIndex++) {
            ...
            if (en == 0) {
                ...
                writeNVM(FLASH_NVM_TYPE, 0xEF80 + (sizeof(Event) + 1 + 20)*tableIndex+1, nodeNumber&0xFF);
                writeNVM(FLASH_NVM_TYPE, 0xEF80 + (sizeof(Event) + 1 + 20)*tableIndex+0, nodeNumber>>8);
                writeNVM(FLASH_NVM_TYPE, 0xEF80 + (sizeof(Event) + 1 + 20)*tableIndex+3, eventNumber&0xFF);
                writeNVM(FLASH_NVM_TYPE, 0xEF80 + (sizeof(Event) + 1 + 20)*tableIndex+2, eventNumber>>8);
                if (forceOwnNN) {
                    writeNVM(FLASH_NVM_TYPE, 0xEF80 + (sizeof(Event) + 1 + 20)*tableIndex+4, 1);
                } else {
                    writeNVM(FLASH_NVM_TYPE, 0xEF80 + (sizeof(Event) + 1 + 20)*tableIndex+4, 0);
                }
                for (e = 0; e < (sizeof(Event) + 1 + 20); e++) {
                    writeNVM(FLASH_NVM_TYPE, 0xEF80 + (sizeof(Event) + 1 + 20)*tableIndex+5 +e, 0);
                }
                error = 0;
                break;
            }
...
# 768 "../../VLCBlib_PIC/event_teach_simple.c"
uint8_t findEvent(uint16_t nodeNumber, uint16_t eventNumber) {
    uint8_t tableIndex;
    for (tableIndex=0; tableIndex < 255; tableIndex++) {
...
# 790 "../../VLCBlib_PIC/event_teach_simple.c"
uint8_t writeEv(uint8_t tableIndex, uint8_t evNum, uint8_t evVal) {
    ...
    writeNVM(FLASH_NVM_TYPE, 0xEF80 + (sizeof(Event) + 1 + 20)*tableIndex+5 +evNum, evVal);
    return 0;
}
# 810 "../../VLCBlib_PIC/event_teach_simple.c"
int16_t getEv(uint8_t tableIndex, uint8_t evNum) {
    if (tableIndex >= 255) {
        return CMDERR_INV_EN_IDX;
    }
    ...
    return (uint8_t)readNVM(FLASH_NVM_TYPE, 0xEF80 + (sizeof(Event) + 1 + 20)*tableIndex+5 +evNum);
}
...
uint8_t getEVs(uint8_t tableIndex) {
    ...
    for (evNum=0; evNum < 20; ) {
        uint8_t evIdx;
        for (evIdx=0; evIdx < (sizeof(Event) + 1 + 20); evIdx++) {
            evs[evNum] = (uint8_t)readNVM(FLASH_NVM_TYPE, 0xEF80 + (sizeof(Event) + 1 + 20)*tableIndex+5 +evIdx);
            evNum++;
        }
    }
    return 0;
}
# 864 "../../VLCBlib_PIC/event_teach_simple.c"
uint16_t getNN(uint8_t tableIndex) {
    uint16_t hi;
    uint16_t lo;
    uint8_t flags;
    ...
    flags = (uint8_t)readNVM(FLASH_NVM_TYPE, 0xEF80 + (sizeof(Event) + 1 + 20)*tableIndex+4);
    if (flags & 1) {
        return nn.word;
    }
    lo = (uint8_t)readNVM(FLASH_NVM_TYPE, 0xEF80 + (sizeof(Event) + 1 + 20)*tableIndex+1);
    hi = (uint8_t)readNVM(FLASH_NVM_TYPE, 0xEF80 + (sizeof(Event) + 1 + 20)*tableIndex+0);
    return lo | (hi << 8);
}
# 888 "../../VLCBlib_PIC/event_teach_simple.c"
uint16_t getEN(uint8_t tableIndex) {
    uint16_t hi;
    uint16_t lo;

    lo = (uint8_t)readNVM(FLASH_NVM_TYPE, 0xEF80 + (sizeof(Event) + 1 + 20)*tableIndex+3);
    hi = (uint8_t)readNVM(FLASH_NVM_TYPE, 0xEF80 + (sizeof(Event) + 1 + 20)*tableIndex+2);
    return lo | (hi << 8);
}
# 910 "../../VLCBlib_PIC/event_teach_simple.c"
static uint8_t evtIdxToTableIndex(uint8_t evtIdx) {
    return evtIdx - 1;
}
